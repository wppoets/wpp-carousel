...
abstract class Admin_Page extends Child_Instance {
	...
	static public function init_config() {
		parent::init_config();
		static::set_default_default( 'enable_admin_footer', FALSE );
		static::set_default_default( 'enable_admin_menu', FALSE );
		static::set_default_default( 'enable_admin_init', FALSE );
	}
